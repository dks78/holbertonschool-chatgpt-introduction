...
class Minesweeper:
    ...
    def reveal(self, x, y):
        # Vérification si on a touché une mine
        if (y * self.width + x) in self.mines:
            return False
        # Révéler la case
        self.revealed[y][x] = True
        # Si aucune mine à proximité, on révèle également les cases adjacentes
    ...
    def play(self):
        while True:
            self.print_board()
            try:
                # Demander à l'utilisateur les coordonnées
